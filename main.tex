...
\textbf{Requisitos atendidos:} RF02, RF03 \\
\textbf{Objetivo:} Listar o nome e o e-mail dos participantes inscritos no evento de maior preço, identificando o público de alto valor. \\
\textbf{Recursos utilizados:} JOIN, SUB-CONSULTAS.
...
\subsection{Consulta Avançada 17 --- Publicações cujo autor também é revisor (conflito de interesse)}
\textbf{Requisitos atendidos:} RF05, RF06, RF08 \\
\textbf{Objetivo:} Detectar casos em que um autor aparece como revisor (mesmo CPF) no sistema, sinalizando potencial conflito de interesse. \\
\textbf{Recursos utilizados:} JOIN, GROUP BY, SUB-CONSULTAS.
...
\textbf{Requisitos atendidos:} RF03, RF09 \\
\textbf{Objetivo:} Listar eventos em que mais de 50\% das inscrições com status \textit{CONCLUIDO} foram pagas via PIX, suportando análise de preferência de método de pagamento. \\
...
\textbf{Recursos utilizados:} JOIN, GROUP BY, COUNT, SUB-CONSULTAS, WINDOW (RANK).
...
QA17 & Avançada & RF05, RF06, RF08 & JOIN, GROUP BY, SUB-QUERY \\
