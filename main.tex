...
\subsubsection{Consulta Avançada 01 --- Participantes que publicaram em todos os eventos em que se inscreveram}
...
\subsubsection{Consulta Avançada 06 --- Revisores que nunca reprovaram nenhuma publicação}
\textbf{Requisitos atendidos:} RF06, RF08 \\
...
\subsubsection{Consulta Avançada 08 --- Participantes com duas ou mais inscrições no mesmo mês}
