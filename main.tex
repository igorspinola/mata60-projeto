...
A análise dos resultados será realizada após a coleta dos tempos de execução. Espera-se que os índices sobre colunas de junção frequente --- como \texttt{id\_evento} em \texttt{rl\_inscricao} e \texttt{id\_evento} em \texttt{rl\_anais} --- produzam os maiores ganhos de desempenho. Índices sobre colunas booleanas, como \texttt{st\_aprovado}, tendem a ser menos eficientes em tabelas pequenas, mas relevantes quando o volume de dados crescer.
